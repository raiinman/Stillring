...
| D-045 | PENDING OWNER REVIEW | Ledge catch/hang existence and trigger are locked; ledge-hang continuation/pull-up, shimmy, deliberate drop, broader climbing scope, swimming, crouch, slope sliding/scrambling, fall damage/recovery, and air-control rules remain unresolved. | Issue #1 |
