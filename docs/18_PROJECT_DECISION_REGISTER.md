...
| D-045 | PENDING OWNER REVIEW | Ledge catch/hang existence, trigger, and hang-to-pull-up continuation are locked; ledge shimmy, deliberate drop, broader climbing scope, swimming, crouch, slope sliding/scrambling, fall damage/recovery, and air-control rules remain unresolved. | Issue #1 |
