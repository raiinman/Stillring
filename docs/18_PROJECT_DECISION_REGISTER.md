...
| D-045 | PENDING OWNER REVIEW | Ledge catch/hang, hang-to-pull-up continuation, and same-handhold lateral shimmy are locked; deliberate drop, broader climbing scope, swimming, crouch, slope sliding/scrambling, fall damage/recovery, and air-control rules remain unresolved. | Issue #1 |
